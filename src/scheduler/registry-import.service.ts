...
@Injectable()
export class RegistryImportService implements OnModuleInit {
  ...
  onModuleInit() {
    ...
    this.logger.log('Планировщик импорта registry инициализирован. Запуск первого импорта...')
  ...
  private scheduleNextImport() {
    ...
    this.logger.log(`Следующий импорт registry запланирован на ${nextRunTime.toLocaleString()}`)
  }
